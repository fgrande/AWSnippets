...
Dim retentionDays As Integer = 30 ' Number of days to retain. 
Dim userName As String = "Administrator" ' It can be use to delete only entries created by a specific user. "*" means all users. Default is the current user.
Dim appName As String = "Application" ' It can be use to delete only entries created by a specific application. Default is the current application.
...
Dim retentionDays As Integer = 30 ' Number of days to retain. If not specified, it will use the configuration default.
